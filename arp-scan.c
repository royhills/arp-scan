...
usage(void) {
   ...
   fprintf(stdout, "\t\t\tinstead of from the command line. One name or IPv4\n");
   ...
   fprintf(stdout, "\n--numeric or -N\t\tTargets must be IP addresses, no hostnames.\n");
   fprintf(stdout, "\t\t\tWith this option, all hosts to be scanned must be\n");
   fprintf(stdout, "\t\t\tspecified as IPv4 addresses. Hostnames cannot be used.\n");
   fprintf(stdout, "\t\t\tThis can reduce the startup time if you have a very\n");
   fprintf(stdout, "\t\t\tlong list of targets which are all IP addresses.\n");
